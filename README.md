...
**Current metaWRAP version = 1.0**. To update, run `conda install metawrap-mg=1.0` (consider backing up your `bin/config-metawrap` file so you dont have to re-do your database configurations)
