**Current metaWRAP version = 0.9.5**. To update, run `conda install metawrap-mg=0.9.5` (consider backing up your `bin/config-metawrap` file so you dont have to re-do your database configurations)
